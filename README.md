...
NOTICE: YOU ARE ON THE TESTING BRANCH! ALL CODE IN THIS BRANCH IS EXTREMELY EXPERIMENTAL AND IS BEING CONSTANTLY WORKED ON! Thus, any bug reports related to 2.0.0 Beta #X will be turned down, rejected, and of course, burned. Most changes from this branch will eventually make it over to the main branch, so please be patient.
