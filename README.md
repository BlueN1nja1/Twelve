...
To differentiate between stable / production builds, all beta / labtest builds will have a green icon instead of the usual pink. Stable builds are unaffected by this.
