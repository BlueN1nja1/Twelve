...
package com.bluen1nja1.twelve.datasources
...
import com.bluen1nja1.twelve.datasources.subsonic.SubsonicClient
import com.bluen1nja1.twelve.datasources.subsonic.models.AlbumID3
import com.bluen1nja1.twelve.datasources.subsonic.models.ArtistID3
import com.bluen1nja1.twelve.datasources.subsonic.models.Child
...
import com.bluen1nja1.twelve.models.ArtistWorks
...
import com.bluen1nja1.twelve.models.GenreContent
import com.bluen1nja1.twelve.models.LocalizedString
import com.bluen1nja1.twelve.models.Lyrics
import com.bluen1nja1.twelve.models.MediaType
import com.bluen1nja1.twelve.models.Playlist
import com.bluen1nja1.twelve.models.ProviderArgument
import com.bluen1nja1.twelve.models.ProviderArgument.Companion.requireArgument
import com.bluen1nja1.twelve.models.Result
import com.bluen1nja1.twelve.models.Result.Companion.getOrNull
...
class SubsonicDataSource(
    ...
    private fun com.bluen1nja1.twelve.datasources.subsonic.models.Genre.toMediaItem() =
        Genre.Builder(getGenreUri(value))
            .setName(value)
            .build()

    private fun com.bluen1nja1.twelve.datasources.subsonic.models.Playlist.toMediaItem() =
        Playlist.Builder(getPlaylistUri(id))
            .setName(name)
            .build()

    private fun com.bluen1nja1.twelve.datasources.subsonic.models.MediaType?.toAudioType() = when (
        this
    ) {
        com.bluen1nja1.twelve.datasources.subsonic.models.MediaType.MUSIC -> Audio.Type.MUSIC
        com.bluen1nja1.twelve.datasources.subsonic.models.MediaType.PODCAST -> Audio.Type.PODCAST
        com.bluen1nja1.twelve.datasources.subsonic.models.MediaType.AUDIOBOOK -> Audio.Type.AUDIOBOOK
        com.bluen1nja1.twelve.datasources.subsonic.models.MediaType.VIDEO -> throw Exception(
    ...
    private fun com.bluen1nja1.twelve.datasources.subsonic.models.LyricsList.toModel() =
