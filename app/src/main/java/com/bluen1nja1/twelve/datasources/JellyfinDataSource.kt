...
import com.bluen1nja1.twelve.datasources.jellyfin.JellyfinClient
import com.bluen1nja1.twelve.datasources.jellyfin.models.Item
import com.bluen1nja1.twelve.datasources.jellyfin.models.ItemType
...
class JellyfinDataSource(
    ...
    private fun com.bluen1nja1.twelve.datasources.jellyfin.models.Lyrics.toModel() = lyrics?.let {
        Lyrics.Builder()
            .apply {
                it.forEach { lyrics ->
                    addLine(
